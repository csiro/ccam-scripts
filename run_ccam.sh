...
sib=cable_sli_modis2020                      # land surface (cable_vary, modis, cable_sli, cable_const, cable_modis2020, cable_sli_modis2020, ccam_era5_evaluation_aus-4i_4km)
aero=prognostic                              # aerosols (off, prognostic)
conv=2017                                    # convection (2014, 2015a, 2015b, 2017, Mod2015a, 2021)
