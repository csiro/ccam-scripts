...
sib=cable_vary                               # land surface (cable_vary, modis, cable_sli, cable_const)
aero=prognostic                              # aerosols (off, prognostic)
conv=Mod2015a                                # convection (2014, 2015a, 2015b, 2017, Mod2015a, 2021)
cloud=liq_ice_rain_snow_graupel              # cloud microphysics (liq_ice, liq_ice_rain, liq_ice_rain_snow_graupel)
rad=SE4                                      # radiation (SE3, SE4)
